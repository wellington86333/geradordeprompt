  ...
  return (
    <footer className="border-t border-border/40 py-8 mt-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-sm text-muted-foreground mt-2 text-center md:text-left">
              Transformando ideias em prompts perfeitos para IA
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-sm">
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Gerador de Prompts</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Templates</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Biblioteca de Exemplos</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Guia de Modelos</a></li>
              </ul>
            </div>
            ...
            <div className="col-span-2 md:col-span-1">
              <h3 className="font-semibold mb-3">Conecte-se</h3>
              ...
              <div className="mt-4">
                ...
                <div className="flex mt-2">
                  <input 
                    ...
                    className="px-3 py-2 bg-secondary/30 rounded-l-md text-sm w-full focus:outline-none focus:ring-1 focus:ring-primary"
                  />
        ...
        <div className="border-t border-border/40 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
          <p>© 2025 PromptMaster. Todos os direitos reservados.</p>
